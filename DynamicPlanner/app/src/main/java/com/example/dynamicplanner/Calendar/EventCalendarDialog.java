...
public class EventCalendarDialog extends LinearLayout {
    ...
    public EventCalendarDialog(Context context) {
        super(context);

    }

    public EventCalendarDialog(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    public EventCalendarDialog(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
